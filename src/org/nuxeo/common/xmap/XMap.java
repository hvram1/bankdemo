...
public class XMap {
    ...
    /**
     * 根据<code>Contribution</code>对象生成对应的dom对象
     * 
     * @param contribution
    ...
    /**
     * 转换java对象为xml字符串，格式是非pretty格式
     * 
     * @param contribution <code>Object</code>实例
     * @param encoding xml encoding
     * @return xml string
     * @throws Exception <code>Exception</code>实例
     */
    ...
    /**
     * 转换java对象为xml字符串，可以使指定格式是否pretty格式
     * 
     * @param contribution <code>Object</code>实例
     * @param encoding xml encoding
     * @return xml string
    ...
    public static void main(String[] args) throws Exception {
        ...
        idAttr.setTextContent("xxxx");

        name.appendChild(firstName);
        name.appendChild(lastName);

        firstName.setTextContent("Hu");
        lastName.setTextContent("Xi");
